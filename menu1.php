...
<?php 
	...
	$voici = new Voiture();
	$voi=$voici->rechercheVoitureParCaractere($_GET['caractere']);//array numeroté vaovao;
 ?>  
<html>
	<head>
		<meta charset="utf-8">
	...
	<body>
	 	<div class="home2">
			...
			<div class="contenu2">
				...
				<div class="gauche2">
				<?php for ($i=0; $i <count($voi) ; $i++) {?> 
					<div class="image1">
					<?php
						echo "<img src='voiture/".$voi[$i]->image.".jpg'>";
					?>
					</div>
					<div class="centre2">
						<?php 
						...
						<strong><?php echo $voi[$i]->type; ?></strong><br><br>
						<span class="nom"><?php echo $voi[$i]->nom;?></span><br><br>
						<b><?php echo $voi[$i]->nom;?></b><br><br>	
